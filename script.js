...
function privacyPage() {
    ...
    display: flex;flex-direction: row;align-items: center;justify-content: space-between;">
        ...
        <div onclick="closePrivacy()"><img src="https://res.cloudinary.com/dmyspflyi/image/upload/v1657577266/supportful/Group_16288_eskjws.png"
    ...
    <br>
        <h4 style="color:#203864;">Colection of information</h4>
        <br>
        <h5 style="margin-bottom: 0.5rem;#203864">Information you provide us</h5>
        ...
        <br><br>
        <h4 style="color:#203864;">Information We Collect Automatically When You Interact with Us
        </h4>
        <br>
\        <p style="line-height: 1.2rem;
        font-size: 13px;
        ...
        <br><br>
        <h4 style="color:#203864;">Information We Collect from Other Sources</h4>
        <p style="line-height: 1.2rem;
        font-size: 13px;
        font-weight: 300;
        opacity: 0.6;
